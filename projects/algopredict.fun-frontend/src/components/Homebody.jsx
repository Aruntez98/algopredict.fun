        ...
        <section className="hero_section" id="hero_section">
            <div className="hero_wrapper">
                ...
                <div className="multichain_betting">
                    ...
                    <p className='multichain_heading'>Multichain Betting is Live</p>
                    <p className='multichain_summary'>Explore, Predict, and win on the hottest new markets on Omni Network.</p>
